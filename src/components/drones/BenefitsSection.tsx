...
export default function BenefitsSection({ page }: { page: DronePageSettings }) {
  const title = page.benefits_title || "Benefícios";
          ...
          {items.map((it, idx) => (
            ...
            >
              <div className="flex items-start gap-3">
                <div className="mt-1 h-8 w-8 rounded-2xl bg-white/10 border border-white/10" />
                <div>
